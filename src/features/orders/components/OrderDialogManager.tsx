...
export const OrderDialogManager = forwardRef<OrderDialogManagerHandle, OrderDialogManagerProps>((props, ref) => {
    ...
    useImperativeHandle(ref, () => ({
        ...
        openExportSlip: (order, type) => { setSelectedOrderForExport(order); setSelectedSlipType(type); setShowExportSlipDialog(true); },
    ...
    return (
        <OrderDialogs
            ...
            selectedSlipType={selectedSlipType}
            setSelectedSlipType={setSelectedSlipType}
