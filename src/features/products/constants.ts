...
import { ProductFilterSchemaType } from './schemas';
import { useCategoriesQuery } from '../categories/hooks';

export type FilterProductFieldConfig = GenericFormFieldConfig<ProductFilterSchemaType>;

export const filterProductConfig: FilterProductFieldConfig[] = [
  {
    label: 'Tìm kiếm',
    name: 'keyword',
    type: 'text',
