...
// import { WarehouseSchemaType } from '../schemas';

// export interface WarehouseDialogActions {
//   openView: (warehouse: WarehouseSchemaType) => void;
//   openEdit: (warehouse: WarehouseSchemaType) => void;
//   openDelete: (warehouse: WarehouseSchemaType) => void;
// }

// interface ProductDataTableProps {
//   warehouses: WarehouseSchemaType[];
//   isLoading: boolean;
//   total: number;
...
//   dialogActions: WarehouseDialogActions;
// }

// export const WarehousesDataTable: React.FC<ProductDataTableProps> = ({
//   warehouses,
//   isLoading,
//   total,
//   pagination,
