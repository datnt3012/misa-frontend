...
// import { ProductFilterSchemaType, ProductFilterSchema } from '../schemas';
// import { ChevronDown, ChevronUp, RotateCcw } from 'lucide-react';
// import { Button } from '@/components/ui/button';
// import { cn } from '@/lib/utils';
// import { FormProvider, useForm } from 'react-hook-form';
// import { yupResolver } from '@hookform/resolvers/yup';
// import { filterProductConfig } from '../constants';
// import { DynamicFormField } from '@/shared/components/DynamicFormField';
// import { getColSpan } from '@/shared/config';

// interface ProductFilterProps {
//   filters: ProductFilterSchemaType;
//   onFilterChange: (filters: ProductFilterSchemaType) => void;
//   defaultExpanded?: boolean;
// }

// const defaultValues: ProductFilterSchemaType = {
//   keyword: '',
//   page: 1,
//   limit: 50,
// };
...
//   const methods = useForm<ProductFilterSchemaType>({
...
//                 {filterProductConfig.slice(0, 3).map((config) => (
//                   <div
//                     key={config.name}
//                     className={cn(
...
//                     )}
//                   >
//                     <DynamicFormField config={config} isFilterVariant={true} />
//                   </div>
//                 ))}
//               </div>
...
//               )}
//             >
//               {filterProductConfig.slice(3).map((config) => (
//                 <div
//                   key={config.name}
//                   className={cn(
//                     'w-full transition-all duration-300',
